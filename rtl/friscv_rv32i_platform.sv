...
module friscv_rv32i_platform
    ...
    logic [2             -1:0] imem_arburst;
    logic [8             -1:0] imem_arlen;
    logic                      imem_rvalid;
    logic                      imem_rready;
    logic                      imem_rlast;
    ...
    logic [2             -1:0] dmem_awburst;
    logic [8             -1:0] dmem_awlen;
    logic                      dmem_awlock;
    logic                      dmem_wvalid;
    logic                      dmem_wready;
    logic                      dmem_wlast;
    ...
    logic [2             -1:0] dmem_arburst;
    logic [8             -1:0] dmem_arlen;
    logic                      dmem_arlock;
    logic                      dmem_rvalid;
    logic                      dmem_rready;
    logic                      dmem_rlast;
    ...
    logic [2             -1:0] ios_awburst;
    logic [8             -1:0] ios_awlen;
    logic                      ios_awlock;
    logic                      ios_wvalid;
    logic                      ios_wready;
    logic                      ios_wlast;
    ...
    logic [2             -1:0] ios_arburst;
    logic [8             -1:0] ios_arlen;
    logic                      ios_arlock;
    logic                      ios_rvalid;
    logic                      ios_rready;
    logic                      ios_rlast;
    ...
    (
        ...
        .slv0_arlen         (imem_arlen),
        .slv0_arsize        ('0),
        .slv0_arburst       (imem_arburst),
        .slv0_arlock        ('0),
        .slv0_arcache       ('0),
        ...
        .slv1_arlen         (dmem_arlen),
        .slv1_arsize        ('0),
        .slv1_arburst       (dmem_arburst),
        .slv1_arlock        (dmem_arlock),
        .slv1_arcache       ('0),
        ...
        .mst0_awlen         (mem_awlen),
        .mst0_awsize        (),
        .mst0_awburst       (mem_awburst),
        .mst0_awlock        (mem_awlock),
        .mst0_awcache       (),
        ...
        .mst0_arlen         (mem_arlen),
        .mst0_arsize        (),
        .mst0_arburst       (mem_arburst),
        .mst0_arlock        (mem_arlock),
        .mst0_arcache       (),
        ...
        .mst1_awlen         (ios_awlen),
        .mst1_awsize        (),
        .mst1_awburst       (ios_awburst),
        .mst1_awlock        (ios_awlock),
        .mst1_awcache       (),
        ...
        .mst1_arlen         (ios_arlen),
        .mst1_arsize        (),
        .mst1_arburst       (ios_arburst),
        .mst1_arlock        (ios_arlock),
        .mst1_arcache       (),
