...
module friscv_icache
    ...
    #(
        ...
        output logic [3             -1:0] imem_arsize,
        output logic [2             -1:0] imem_arburst,
        output logic                      imem_arlock,
        output logic [4             -1:0] imem_arcache,
        output logic [3             -1:0] imem_arprot,
        output logic [4             -1:0] imem_arqos,
        output logic [4             -1:0] imem_arregion,
    ...
    (
        ...
        .mem_arready    (imem_arready),
        .mem_araddr     (imem_araddr),
        .mem_arlen      (imem_arlen),
        .mem_arsize     (imem_arsize),
        .mem_arburst    (imem_arburst),
        .mem_arlock     (imem_arlock),
        .mem_arcache    (imem_arcache),
        .mem_arprot     (imem_arprot),
        .mem_arqos      (imem_arqos),
        .mem_arregion   (imem_arregion),
        .mem_arid       (imem_arid),
        .mem_rvalid     (imem_rvalid),
        .mem_rready     (imem_rready),
        .mem_rid        (imem_rid),
        .mem_rresp      (imem_rresp),
        .mem_rdata      (imem_rdata),
        .mem_rlast      (imem_rlast)
    );
